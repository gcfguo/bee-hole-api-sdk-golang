...
type XbuyAppFormAdminFormPostFeeModeAddReq struct {
	// 运费方式编号
	...
	FixedFreight string `json:"fixed_freight,omitempty"`
	// 首重、首件
	FirstPiece string `json:"first_piece,omitempty"`
	// 首重(首件)费用
	FirstAmount string `json:"first_amount,omitempty"`
	// 续重、续件
	SecondPiece string `json:"second_piece,omitempty"`
	// 续重(续件)费用
	SecondAmount string `json:"second_amount,omitempty"`
	...
	// 启用运费方式子条件
	CarrySubMode string `json:"carry_sub_mode,omitempty"`
}
